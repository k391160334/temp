...
QT_MOC_LITERAL(1, 4, 8), // "setAngle"
QT_MOC_LITERAL(2, 13, 0), // ""
QT_MOC_LITERAL(3, 14, 1) // "a"
...
void qTh::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->setAngle((*reinterpret_cast< float(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (qTh::*)(float );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&qTh::setAngle)) {
                *result = 0;
                return;
            }
        }
